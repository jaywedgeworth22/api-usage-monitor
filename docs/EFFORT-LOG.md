...
- **Remaining-provider automatic enrichment implementation wave (CODEX + provider teams,
  owner-directed 2026-07-13) — IN PROGRESS.** Branch `codex-provider-enrichment-wave`, isolated
  ...
  SQLite backup, startup config, and production build. Ready to push for review.
